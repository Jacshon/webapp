...
import com.github.webapp.backend.common.constant.Constant;
...
//    @Override
//    @Cacheable(value = Constant.CACHE_CONSTANT, key = "'" + Constant.ROLES_NAME + "'+#roleIds")
...
//        for (Long role : roles) {
//            SysRole sysRole = roleMapper.selectById(role);
//            if (sysRole != null && StringUtil.isNotEmpty(sysRole.getName())) {
