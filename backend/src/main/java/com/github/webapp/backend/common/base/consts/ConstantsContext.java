package com.github.webapp.backend.common.base.consts;

import com.github.webapp.backend.common.base.enums.CommonStatus;
...
import static com.github.webapp.backend.common.base.consts.ConfigConstant.SYSTEM_CONSTANT_PREFIX;

/**
 * @author wangweijiang
 * @since 2019-10-29 13:50
 */
@Slf4j
public class ConstantsContext {
    ...
    public static String getOAuth2UserPrefix() {
        ...
        if (StringUtils.isEmpty(oauth2Prefix)) {
    ...
    public static Boolean getDefaultAdvert() {
        ...
        if (StringUtils.isEmpty(gunsDefaultAdvert)) {
    ...
    public static String getFileUploadPath() {
        ...
        if (StringUtils.isEmpty(gunsFileUploadPath)) {
    ...
    public static String getBpmnFileUploadPath() {
        ...
        if (StringUtils.isEmpty(bpmnFileUploadPath)) {
    ...
    public static String getJwtSecret() {
        ...
        if (StringUtils.isEmpty(systemReleaseVersion)) {
            String randomSecret = getRandomString(32);
    ...
    public static Boolean getTenantOpen() {
        ...
        if (StringUtils.isEmpty(tenantOpen)) {
